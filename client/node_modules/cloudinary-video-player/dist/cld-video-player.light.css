...
.cld-video-player .vjs-subs-caps-button .vjs-menu {
  width: auto;
  left: -5em;
}
.cld-video-player .vjs-subs-caps-button .vjs-menu-content {
  width: auto;
  overflow: visible;
  padding: 0.2em 0;
}
...
.cld-video-player .vjs-subs-caps-button .vjs-menu-item {
  text-align: left;
  white-space: nowrap;
...
.cld-video-player .vjs-subs-caps-button .vjs-menu-item.vjs-captions-menu-item .vjs-menu-item-text .vjs-icon-placeholder {
  vertical-align: top;
  display: inline-block;
  margin-bottom: -0.3em;
}
